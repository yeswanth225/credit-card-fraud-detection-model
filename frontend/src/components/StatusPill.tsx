...
export const StatusPill: React.FC<StatusPillProps> = ({
  ...
  return (
    <motion.span
      ...
      className={`inline-flex items-center rounded-full border ${config.bgTint} ${config.borderColor} ${config.textColor} ${sizeClasses} whitespace-nowrap transition-colors duration-200`}
    >
